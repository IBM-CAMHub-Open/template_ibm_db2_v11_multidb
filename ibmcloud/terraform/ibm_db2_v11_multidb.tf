...
# This is a terraform generated template generated from ibm_db2_v11_multidb
...
variable "DB2Node01_disk1_size" {
  type = "string"
  description = "Disk1 - DB2Node01 Size"
  default = "100"
}
...
resource "ibm_compute_vm_instance" "DB2Node01" {
  ...
  disks = ["${var.DB2Node01_root_disk_size}", "${var.DB2Node01_disk1_size}"]
...
output "DB2Node01_roles" {
  value = "db2_create_db,db2_v111_install,linux_cloud_lvm"
}
